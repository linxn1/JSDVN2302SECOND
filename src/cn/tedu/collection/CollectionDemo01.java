...
/**
 * java集合类
 * 集合和数组一样，都是用于保存一组数据，但是集合将元素都封装成了方法，操作更简便
 * 并且集合提供了很多不同的实现类供我们使用
 * <p>
 * java.util.Collection是所有集合的顶级接口，里面定义了所有集合都必须具备的功能方法
 * 集合的两类常用子类
 * 1.java.util.List：可以重复的集合，且有序，通常我们称为叫做线性表
 * 2.java.util.Set：可以重复的集合
...
public class CollectionDemo01 {
    public static void main(String[] args) {
         ...
         * 此处参数E其实是泛型，先理解为是Object类型
         * 集合存储的元素必须是引用类型
         * 并且一般使用时，集合中存储的元素类型都是一致的
         */
        c.add("one");
        c.add("two");
        c.add("three");
        c.add("four");
        c.add("five");
        //1是基本类型，此处触发自动集装箱特性int->Interger
        c.add(1);
